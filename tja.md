...
`dan.json` | **Dan**-i **JSON** (?) | JSON | TaikøNauts | On-or-before 2025-11-16 (first known generation tool) <br /> 2026-04-08 (first official documentation) | Documentation is in the TaikøNauts Official Server <https://discord.gg/rddyYErDMe>. <br /> See the official converter <https://tools.taiko.team/> and the non-official converter <https://github.com/fjfjdkdk706-lgtm/TaikoNautsdan-Conversion-tool>. <br/> An `.mc` file with Taiko mode can be played as a Taiko chart.
