...
`I` | (same as `5`) <br /> Head of regular <ruby>カ<rt>Ka</rt> ツ<rt>tsu</rt></ruby> (bar) *<ruby>連<rt>Ren</rt> 打<rt>da</rt></ruby>* drumroll (OutFox) | (see `5`) <br /> Small red circle with bar attached behind (OutFox) | (see `5`) <br /> Roll on the drum rim for score bonus (OutFox) | By analogy with Konga mode <br /> *Proposal* from OutFox. | ***First seen in***: OpenTaiko (0auBSQ) v0.5.4, OutFox v0.4.18
...
`H` | (same as `6`) <br /> Head of regular <ruby>ド<rt>Do</rt> ン<rt>n</rt></ruby> (bar) *<ruby>連<rt>Ren</rt> 打<rt>da</rt></ruby>* drumroll (OutFox) | (see `6`) <br /> (same as `I`) (OutFox) | (see `6`) <br /> Roll on the drum surface for score bonus (OutFox) | By analogy with Konga mode <br /> *Proposal* from OutFox. | ***First seen in***: OpenTaiko (0auBSQ) v0.5.4, OutFox v0.4.18
...
`C` | Bomb/mine | Small dark-blue cherry bomb with ignited fuze 💣 | (none) | Combo-break and *<ruby>魂<rt>tamashii</rt> ゲー<rt>gee</rt>ジ<rt>ji</rt></ruby>* spirit gauge/soul gauge penalty if caught | ***First seen in***: OutFox v0.4.9.9 <br /> ***Supported by***: OpenTaiko (0auBSQ) v0.5.4
`D` | Fuze/fuse drumroll | ? <br /> (Big circular clock with blue-ish purple edge and with bar attached behind in OpenTaiko (0auBSQ)) | (<ruby>時<rt>Ji</rt> 爆<rt>baku</rt>弾<rt>dan</rt></ruby> "Time bomb"/Fuseroll in OpenTaiko (0auBSQ)) | Roll on the drum surface with certain amount of hits, combo-break (or BAD?) (in OpenTaiko (0auBSQ)) and *<ruby>魂<rt>tamashii</rt> ゲー<rt>gee</rt>ジ<rt>ji</rt></ruby>* spirit gauge/soul gauge penalty if failed to do so <br> Not in the official games. <br /> *Proposal* from OutFox. | ***First seen in***: OpenTaiko (0auBSQ) v0.6.0
...
`G` | Swap note | (Vary) <br /> Big green circle in taiko-web (plugin "Green Notes") <br /> Big purple circle in OpenTaiko (0auBSQ) <br /> (same as `1`) (OutFox) | (*<ruby>グ<rt>Gu</rt> リー<rt>rii</rt> ン<rt>n</rt></ruby>* Green) <br /> (*<ruby>カ<rt>Ka</rt> ド<rt>do</rt> ン<rt>n</rt></ruby>* KADON) | Hit the drum surface on left or right side **&** the drum rim on the other left or right side. <br> Not in the official games. | ***First seen in***: taiko-web (plugin "Green Notes") <br /> ***Supported by***: OpenTaiko (0auBSQ) v0.5.4, OutFox v0.4.18
...
`G` | (same as `3`) | (see `3`) | (see `3`) | By analogy with Taiko mode. | ***First seen in***: OpenTaiko (0auBSQ) v0.5.4, OutFox v0.4.18
...
`C` | Bomb/mine | (Small dark-blue cherry bomb with ignited fuze 💣) | (none) | Combo-break and *<ruby>魂<rt>tamashii</rt> ゲー<rt>gee</rt>ジ<rt>ji</rt></ruby>* spirit gauge/soul gauge penalty if caught <br /> Not in the official games. <br /> By analogy with Taiko mode. | ***First seen in***: OutFox v0.4.9.9 <br /> ***Supported by***: OpenTaiko (0auBSQ)
`D` | Fuze/fuse drumroll | (Big circular clock with blue-ish purple edge and with bar attached behind in OpenTaiko (0auBSQ)) | (<ruby>時<rt>Ji</rt> 爆<rt>baku</rt>弾<rt>dan</rt></ruby> "Time bomb"/Fuseroll in OpenTaiko (0auBSQ)) | Roll on either bongo drum with certain amount of hits, combo-break (or BAD?) (in OpenTaiko (0auBSQ)) and *<ruby>魂<rt>tamashii</rt> ゲー<rt>gee</rt>ジ<rt>ji</rt></ruby>* spirit gauge/soul gauge penalty if failed to do so <br> Not in the official games. <br /> By analogy with Taiko mode. <br /> *Proposal* from OutFox. | ***First seen in***: OpenTaiko (0auBSQ) v0.6.0
